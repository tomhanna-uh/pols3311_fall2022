...
## Recap on Globalization, Trade, Conflict
...
5. Ideological talking points that don't recognize 1 to 3 bias results.
...
Globalization (trade and financial liberalization) has been blamed or praised for:
                ...
                1. Decreasing absolute poverty
                2. Increasing inequality
                3. Improving median incomes
                4. Causing unemployment in manufacturing communities
                5. Raising living standards of the poorest people
                6. Increasing total employment/productivity for all trading partners

+ All of these *can* be true
+ All of these *are* empirically valid statements of the real world
+ None of these address other issues like conflict, the environment, or labor rights
