...
+ Midterm 
                ...
                + will include material through today (October 5)
                + Midterm review will be October 10, approximately thirty minutes
                + I will post some key term definitions before October 10
                + The Reading List has some notes on the readings that catch some key points
                + You should look for italicized and bold face points in the lecture materials
                + Also AT A MINIMUM (C level) understand the "recap" items from each lecture
...
-   Simple models of outcomes (Hotelling, Downs, Duverger)
                  ...
                  + What is a model? Why use simple models?
