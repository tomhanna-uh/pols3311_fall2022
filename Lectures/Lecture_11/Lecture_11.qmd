...
3 - Majority rule^[Technically the election is required to satisfy the *Condorcet winner criterion*. A simple majority system is one way to do this.]
...
**Duverger's Law**: Single ballot majoritarian systems^[The strongest form of these are First Past the Post systems which require only a plurality] with single member districts tend to produce strong two party systems. 
